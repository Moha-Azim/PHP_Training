...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $selc = "SELECT * FROM admins WHERE Email='$email' and Password='$password'";
    $doing = $connection->query($selc);

    if($doing -> num_rows > 0){
        $_SESSION['is_admin_in'] = 1;
    }else{
...
require('../Final Project/#02foreach.php')
?>
                ...
                <div class="row tm-content-row">
                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
                        <div class="tm-bg-primary-dark tm-block tm-block-products">
                            <h2 style='text-align:center; color:#FFF'>Books</h2>
                            ...
                            <!-- table container -->
                            <a href="add-product.php" class="btn btn-primary btn-block text-uppercase mb-3">Add new
                                Book</a>
